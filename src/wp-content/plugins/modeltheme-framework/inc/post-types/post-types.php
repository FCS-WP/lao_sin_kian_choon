 ...
 */
function groffer_testimonial_custom_post() {
...
add_action('init', 'groffer_testimonial_custom_post');
 ...
 */
function groffer_client_custom_post() {
...
add_action('init', 'groffer_client_custom_post');
