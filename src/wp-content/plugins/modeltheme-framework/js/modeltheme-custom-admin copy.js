...
(function ($) {
  'use strict';
	...
	jQuery( document ).ready(function() {
	    ...
	    jQuery( "#redux_demo-groffer_skin_color .redux-image-select" ).on( "click", function() {
	      
	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_1 redux-image-select-selected'){
	            var bg_color = '#00ADEF',
	            	bg_color_hover = '#0096d1',
	            	bg_color_semitransparent = 'rgba(0, 173, 239, 0.95)';
	        }  

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_2 redux-image-select-selected'){
	            var bg_color = '#2DCC70',
	            	bg_color_hover = '#27ae60',
	            	bg_color_semitransparent = 'rgba(46, 204, 113, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_3 redux-image-select-selected'){
	            var bg_color = '#1BBC9B',
	            	bg_color_hover = '#16a085',
	            	bg_color_semitransparent = 'rgba(26, 188, 156, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_4 redux-image-select-selected'){
	            var bg_color = '#95A5A5',
	            	bg_color_hover = '#7f8c8d',
	            	bg_color_semitransparent = 'rgba(149, 165, 166, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_5 redux-image-select-selected'){
	            var bg_color = '#E77E23',
	            	bg_color_hover = '#d35400',
	            	bg_color_semitransparent = 'rgba(230, 126, 34, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_6 redux-image-select-selected'){
	            var bg_color = '#E84C3D',
	            	bg_color_hover = '#c0392b',
	            	bg_color_semitransparent = 'rgba(231, 76, 60, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_7 redux-image-select-selected'){
	            var bg_color = '#F1C40F',
	            	bg_color_hover = '#f39c12',
	            	bg_color_semitransparent = 'rgba(241, 196, 15, 0.95)';
	        }

	        if (jQuery(this).attr('class') == 'redux-image-select groffer_skin_color_8 redux-image-select-selected'){
	            var bg_color = '#9B58B5',
